...
public class idParser extends Parser {
	...
	public static final int
		...
		DECREMENTADOR=18, COMILLA=19, COMA=20, CADENA=21, CARACTER=22, MAYOR=23, 
		MENOR=24, MAYOR_IGUAL=25, MENOR_IGUAL=26, IGUAL=27, DISTINTO=28, AND=29, 
		OR=30, IF=31, ELSE=32, FOR=33, WHILE=34, BREAK=35, CONTINUE=36, RETURN=37, 
		IDENTIFICADOR=38, NUMERO_DOUBLE=39, NUMERO=40, OTRO=41;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"COMILLA", "COMA", "CADENA", "CARACTER", "MAYOR", "MENOR", "MAYOR_IGUAL", 
			"MENOR_IGUAL", "IGUAL", "DISTINTO", "AND", "OR", "IF", "ELSE", "FOR", 
			"WHILE", "BREAK", "CONTINUE", "RETURN", "IDENTIFICADOR", "NUMERO_DOUBLE", 
			"NUMERO", "OTRO"
		};
	}
	...
	public final Llamada_funcion_expresionContext llamada_funcion_expresion() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1924149542912L) != 0)) {
				{
				setState(301);
