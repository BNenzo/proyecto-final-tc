...
public class idParser extends Parser {
	...
	public static final int
		...
		RULE_llamada_funcion = 33, RULE_parametros_llamada_funcion = 34, RULE_if = 35, 
		RULE_while = 36, RULE_for = 37, RULE_for_declaracion = 38, RULE_for_autoincremental = 39;
	...
	public final For_declaracionContext for_declaracion() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_for_declaracion);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final For_autoincrementalContext for_autoincremental() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_for_autoincremental);
		try {
			int _alt;
			setState(345);
			_errHandler.sync(this);
